...
import RegisterProcessComponent from './module/registerProcess/components/RegisterProcessComponent';
  ...
  return (
    <Routes>
      ...
      <Route path={routesName.dashboard} element={<ProtectedRoute element={<DashboardLayout />} />}>
        ...
        <Route path={routesName.registerProcess} element={<RegisterProcessComponent />} />
